	...
	<div class="main_div">
		...
		<div class="numberOfOrganizer">
			<div class="countOrganizer">Organizers<br><br>
				<span><?php $sql2="SELECT COUNT(organizer_id) AS noOfOrg FROM organizers";
		...
		<div class="amountCollected">
			<div class="countAmount">Collected<br><br>
				<span><?php $sql3="SELECT SUM(donate_amount) AS amnt FROM ss_receipt WHERE admin_approval=1 ";
		...
		<div class="totalDonors">
			<div class="countDonors">Donors<br><br>
				<span><?php $sql4="SELECT Count(email_id) AS noOfDonor FROM ss_receipt WHERE admin_approval=1";
