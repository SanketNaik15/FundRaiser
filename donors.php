    ...
    <div class="main-container">
        ...
        <table>
            <tr>
                ...
                <th width="25%">Donated Amount ( RS )</th>
                <th width="25%">campaign</th>
            </tr>
            <!-- logic to display donors -->
            <?php 
                    include 'includes/dbh.inc.php';
                    $sql = "SELECT * FROM campaigns,ss_receipt,donors
                    WHERE ss_receipt.admin_approval = 1
                    AND donors.donor_email = ss_receipt.email_id 
                    AND campaigns.campaign_id = ss_receipt.campaign_id
                    ORDER BY donor_amount desc;";
                    ...
                    if($resultCheck > 0) {
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            $donatedAmount = $row['donor_amount'];
