...
if(!isset($_POST['submit'])) { //if one try to access signup.inc.php without access
    ...
    if(!preg_match("/^[a-zA-Z'. -]+$/", $fullname)) {    
        ...
        if($resultCheck > 0) {
            ...
            $sql = "INSERT INTO organizers(organizer_fullname, organizer_username, organizer_email, organizer_password, organizer_phone) VALUES('$fullname','$username','$email','$hashedPassword','$phone');";
